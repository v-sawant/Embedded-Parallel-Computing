...
//    printf("H[%u]:\n", last_index); matrix_show2((Double*)shm.H[last_index], IN_ROWS, IN_ROWS);
	...
	if(cid == (l/2)%COREUSED){
        ...
        delay(); //EXTRA
//	unsigned int timer_val = e_ctimer_stop(E_CTIMER_0);
//	shm.test = timer_val;
//	e_wait(E_CTIMER_0, WAIT_CLICKS);
//	e_ctimer_set(E_CTIMER_0, timer_val);
//	e_ctimer_start(E_CTIMER_0, E_CTIMER_CLK);
...
{
	init_timer ();
//	unsigned int timer_val = e_ctimer_get(E_CTIMER_0);
//	shm.test = timer_val;
	...
	delay();
//	timer_val = e_ctimer_stop(E_CTIMER_0);
//	shm.test = timer_val;
//	e_wait(E_CTIMER_0, WAIT_CLICKS);
//	e_ctimer_set(E_CTIMER_0, timer_val);
//	e_ctimer_start(E_CTIMER_0, E_CTIMER_CLK);
